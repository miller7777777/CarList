        ...
        api.getCars().enqueue(new retrofit2.Callback<CarList>() {
            ...
            public void onResponse(retrofit2.Call<CarList> call, retrofit2.Response<CarList> response) {
                if (response.isSuccessful()) {
                    ...
                    RequestManager imageRequestManager = Glide.with(MainActivity.this);
                    recyclerView.setAdapter(new CarAdapter(carsResponse.getCars(), imageRequestManager, new OnListItemClickListener() {
                        @Override
